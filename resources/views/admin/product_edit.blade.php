        ...
        <form action="" method="post" class="form form-horizontal" id="form-product-add">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <div class="uploader-thum-container">
                        <img id="preview_id" src="{{$product->preview}}" class="img-responsive" style="width: 100px" alt="预览">
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">
                    ...
                    价格：</label>
                <div class="formControls col-xs-6 col-sm-6">
                    <input type="number" class="input-text" value="{{$product->price}}" placeholder="" name="price">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">
				...
				<select name="category_id" class="select">
                    ...
                    @foreach($parent_categories as $parent_category)
                        @if($parent_category->id == $product->category_id)
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-6 col-sm-6 required">
                    <div class="radio-box">
                        <input type="radio" name="platform" value="1" @if($product->platform == 1) checked @endif>
                        <label for="radio-1">PS4</label>
                    </div>
                    <div class="radio-box">
                        <input type="radio" name="platform" value="2" @if($product->platform == 2) checked @endif>
                        <label for="radio-2">XBOX</label>
                    </div>
                    <div class="radio-box">
                        <input type="radio" name="platform" value="3" @if($product->platform == 3) checked @endif>
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">
                    ...
                    详细描述：</label>
                <div class="formControls col-xs-6 col-sm-6">
                    <textarea name="summary" cols="" rows="" class="textarea"  placeholder="详细描述...最少输入10个字符" onKeyUp="$.Huitextarealength(this,100)">{{$product->summary}}</textarea>
    ...
    <script type="text/javascript">
        ...
        $("#form-product-add").validate({
            ...
            submitHandler:function(form){
                $(form).ajaxSubmit({
                    type: 'post',
                    url: '/admin/service/product/edit/{{$product->id}}',
                    dataType: 'json',
                    data: {
